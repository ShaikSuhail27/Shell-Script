...
# VALIDATE $? "appending" 
 cat /home/centos/Shell-Script/GmailConf.cf >> /etc/postfix/main.cf &>>$LOGFILE
 VALIDATE $? "appending" 
...
echo "This is a test mail & Date $(date)" | mail -s "messages-finally" shaiksuhail2727@gmail.com 
